    ...
    execute(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!!context.params.box) {
                let box = yield this._boxRepo.findOne({ code: context.params.box });
                if (!!box) {
                    let updatedJob = yield this._jobService.attachBox(context.params.job, box);
                    return updatedJob;
                }
                else {
...
//# sourceMappingURL=AssignJobBox.js.map