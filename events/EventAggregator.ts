...
export class EventAggregator {
    ...
    public static getSensorEvent(sensor: Sensor): string {
        switch (sensor.type) {
            ...
            case (SensorTypes.activator):
                return EventAggregator.boxActivatorChanged;
            default:
                return null;
        }
    }
    ...
    public static boxSensorChanged:string = config.get('events.boxSensorChanged') as string;
    public static boxActivatorChanged:string = config.get('events.boxActivatorChanged') as string;
